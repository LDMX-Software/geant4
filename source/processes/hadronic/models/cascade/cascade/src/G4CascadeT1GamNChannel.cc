...
namespace {
  ...
  static const G4double upK2f = G4CascadeParameters::kaonEnhancementFactor(); // default 25
  static const G4double upK3f = G4CascadeParameters::kaonEnhancementFactor(); // default 25
