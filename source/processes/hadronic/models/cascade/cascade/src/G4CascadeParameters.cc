...
G4CascadeParameters::G4CascadeParameters()
  : G4CASCADE_VERBOSE(getenv("G4CASCADE_VERBOSE")),
    ...
    G4CASCADE_KAON_ENHANCEMENT_FACTOR(getenv("G4CASCADE_KAON_ENHANCEMENT_FACTOR")),
    messenger(0) {
...
void G4CascadeParameters::Initialize() {
  ...
  KAON_ENHANCEMENT_FACTOR = (G4CASCADE_KAON_ENHANCEMENT_FACTOR ? strtod(G4CASCADE_KAON_ENHANCEMENT_FACTOR,0) : 25.0);
  if(G4CASCADE_KAON_ENHANCEMENT_FACTOR=="")   KAON_ENHANCEMENT_FACTOR=25.0;

  if(KAON_ENHANCEMENT_FACTOR>30.|| KAON_ENHANCEMENT_FACTOR < 0.0){
    G4cerr << " INVALID KAON ENHANCEMENT FACTOR.  VALID RANGE IS FROM 0 TO 30. " << G4endl
	   << "RESETTING TO DEFAULT VALUE OF 25." << G4endl;
    KAON_ENHANCEMENT_FACTOR=25.0;
  }
  G4cout << " Using KAON_ENHANCEMENT_FACTOR = " << KAON_ENHANCEMENT_FACTOR;
  if(G4CASCADE_KAON_ENHANCEMENT_FACTOR) 
    G4cout << "  (INPUT " << G4CASCADE_KAON_ENHANCEMENT_FACTOR << ")" << G4endl;
  else 
    G4cout << " (set env variable G4CASCADE_KAON_ENHANCEMENT_FACTOR to value between 0 and 30 to modify) " << G4endl;
}
